...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToOne(inversedBy: 'leaderId')]
    private ?Team $TeamLeaderId = null;
    ...
    public function removeTeamId(Team $teamId): static
    {
        if ($this->TeamId->removeElement($teamId)) {
            $teamId->removeUser($this);
        }

        return $this;
    }

    public function getTeamLeaderId(): ?Team
    {
        return $this->TeamLeaderId;
    }

    public function setTeamLeaderId(?Team $TeamLeaderId): static
    {
